...
echo "# generated by 'dconf dump /org/gnome/shell/'" > desktop/gnome/dconf-shell.ini
dconf dump /org/gnome/shell/ | sed \
    ...
    -e '/history=/d' \
    -e '/input-mode-list=/d' \
    >> desktop/gnome/dconf-shell.ini

# 2. Dump Desktop settings (Interface, Peripherals)
# Usually cleaner, but good to be safe
echo "# generated by 'dconf dump /org/gnome/desktop/'" > desktop/gnome/dconf-desktop.ini
